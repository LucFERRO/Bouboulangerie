...
1. Go to Dashboard >> Pages >> Add New, Create a new Page and name it, add the content, featured image (image size 1600px x 582px) and publish the page. Repeat the same step for other slider pages.
...
2. Go to Dashboard >> Products >> Add New, Create a new product and name it, set it's featured image, add the content, add price and publish the product. Repeat the step for other featured products.
...
4. Go to Customizer >> Theme Settings >> Featured Products, add section short title, section title and select the product page that you have created and publish it.
...
* PxHere Images
	...
	Slider image
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/987781

	Product image
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/886504

	Product image
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/1046593

	Product image
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/869028

	Product image
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pxhere.com/en/photo/987776
